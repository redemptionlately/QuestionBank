...
- 源码索引（会背会写）：[PaperVersion.java](../../src/main/java/com/allen/questionbank/bank/PaperVersion.java) 第 6-17 行的 Entity/字段映射；[V1__m0_schema.sql](../../src/main/resources/db/migration/V1__m0_schema.sql) 第 21-47 行的 paper/question 表结构
...
- 源码索引（必须理解）：[PracticeSession.java](../../src/main/java/com/allen/questionbank/practice/PracticeSession.java) 第 8-19 行的 Persistence Context 字段与 `@Version`；[V1__m0_schema.sql](../../src/main/resources/db/migration/V1__m0_schema.sql) 第 49-86 行的练习/错题外键与唯一键
