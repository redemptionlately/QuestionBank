...
- 异常转换的代码形态是：
  ...
  ```
- 源码索引（MustRemember）：[GlobalExceptionHandler.java](../../src/main/java/com/allen/questionbank/common/GlobalExceptionHandler.java) 第 17-53 行的 `@ExceptionHandler` 分支和统一 `response` 方法
