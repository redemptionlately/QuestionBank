...
- 外部源码索引（MustUnderstand）：[MySQL locking](https://dev.mysql.com/doc/refman/8.4/en/innodb-locking.html)、[MySQL EXPLAIN](https://dev.mysql.com/doc/refman/8.4/en/explain.html)
