...
- 外部源码索引（MustUnderstand）：[Spring ApplicationContext](https://docs.spring.io/spring-framework/reference/core/beans.html)、[Spring Boot Actuator](https://docs.spring.io/spring-boot/reference/actuator.html)
