...
- 外部源码索引（必须理解）：[OWASP Authentication Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html)、[JWT BCP RFC 8725](https://datatracker.ietf.org/doc/html/rfc8725)
