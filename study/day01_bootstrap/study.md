...
- 源码索引（会背会写）：[QuestionBankApplication.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/QuestionBankApplication.java) 第 6-11 行的启动类；[QuestionBank.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/QuestionBank.java) 第 6-30 行的 Entity、字段、JPA 无参构造器和业务构造器；[QuestionBankRepository.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/QuestionBankRepository.java) 第 1-5 行的 `JpaRepository` 声明；[BankService.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/BankService.java) 第 14-33 行的构造器注入、校验、实体创建和 `save`；[BankController.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/BankController.java) 第 13-24、58-62 行的路由、权限、DTO 和响应投影；[pom.xml](../../../../projects/java-question-bank-m0/pom.xml) 第 7-12、24-83 行的 parent、dependencies 和插件
...
- 源码索引（必须理解）：[QuestionBankApplication.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/QuestionBankApplication.java) 第 6-9 行的 `SpringApplication.run` 到 ApplicationContext；[BankController.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/BankController.java) 第 20-24 行的 HTTP 输入、认证主体、Service 调用和 DTO 输出；[BankService.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/BankService.java) 第 29-33、102-105 行的事务、业务校验、持久化和异常语义；[pom.xml](../../../../projects/java-question-bank-m0/pom.xml) 第 24-74 行的 starter、runtime 与 test scope 依赖边界
- 外部源码索引（会背会写）：[java.util.function](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/package-summary.html) 的四类函数式接口；[Stream API](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/stream/Stream.html) 的 `map/filter/flatMap/collect`
- 外部源码索引（必须理解）：[Optional API](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Optional.html) 的缺失语义和异常边界
