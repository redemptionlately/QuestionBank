...
- 外部源码索引（必须理解）：[Java Language Specification](https://docs.oracle.com/javase/specs/jls/se21/html/)、[Java Object Serialization 安全说明](https://docs.oracle.com/en/java/javase/21/core/serialization-filtering1.html)
