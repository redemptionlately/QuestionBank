...
- 外部源码索引（会背会写）：[Snowflake paper](https://blog.twitter.com/engineering/en_us/a/2010/announcing-snowflake)、[Redis distributed locks](https://redis.io/docs/latest/develop/clients/patterns/distributed-locks/)、[Saga pattern](https://microservices.io/patterns/data/saga.html)
...
- 外部源码索引（必须理解）：[DDIA consistency](https://dataintensive.net/)、[MySQL XA limitations](https://dev.mysql.com/doc/refman/8.4/en/xa.html)
