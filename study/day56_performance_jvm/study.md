...
- 外部源码索引（必须理解）：[Java Flight Recorder](https://docs.oracle.com/javacomponents/jmc-8/jfr-runtime-guide/about-jfr.htm)、[G1 GC tuning](https://docs.oracle.com/en/java/javase/21/gctuning/)
