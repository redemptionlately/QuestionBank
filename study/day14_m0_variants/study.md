...
- 包边界代码形态是：
  ...
  ```
- 源码索引（会背会写）：[BankController.java](../../src/main/java/com/allen/questionbank/bank/BankController.java) 第 20-46 行的题库/发布/查询接口；[PracticeController.java](../../src/main/java/com/allen/questionbank/practice/PracticeController.java) 第 21-44 行的练习接口
...
- 源码索引（必须理解）：[题库平台项目蓝图](../../../AI_Infra/Phases_book/题库平台项目蓝图.md) 的 M0/M1/M2 边界；[README.md](../../README.md) 的 Scope 与 Verification
