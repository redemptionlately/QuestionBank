...
- 外部源码索引（会背会写）：[Redis Lua](https://redis.io/docs/latest/develop/programmability/eval-intro/)、[RabbitMQ confirms](https://www.rabbitmq.com/docs/confirms)、[Kafka consumer](https://kafka.apache.org/documentation/#consumerconfigs)、[Transactional Outbox](https://microservices.io/patterns/data/transactional-outbox.html)
...
- 外部源码索引（必须理解）：[Redis persistence and replication](https://redis.io/docs/latest/operate/oss_and_stack/management/persistence/)、[Kafka delivery semantics](https://kafka.apache.org/documentation/#semantics)、[RabbitMQ consumer acknowledgements](https://www.rabbitmq.com/docs/confirms)
