...
- M0 请求 DTO 的源码形态是：
  ...
  ```
- 源码索引（会背会写）：[BankController.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/BankController.java) 第 20-65 行的参数绑定、`@PreAuthorize` 和 record DTO；[PracticeController.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/practice/PracticeController.java) 第 27-35 行的路径变量/请求头
...
- 源码索引（必须理解）：[GlobalExceptionHandler.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/common/GlobalExceptionHandler.java) 第 19-44 行的异常分类与 HTTP 状态映射
