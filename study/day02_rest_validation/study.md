...
- 源码索引（会背会写）：[BankController.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/bank/BankController.java) 第 20-31 行的管理员接口、第 58-65 行的 DTO/record；重点是注解、参数绑定和 DTO 构造
...
- 源码索引（必须理解）：[GlobalExceptionHandler.java](../../../../projects/java-question-bank-m0/src/main/java/com/allen/questionbank/common/GlobalExceptionHandler.java) 第 24-39 行的校验、缺 Header 和坏 JSON 异常映射
