...
- 外部源码索引（必须理解）：[Linux man-pages](https://man7.org/linux/man-pages/)、[Kubernetes Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/)、[12-factor config](https://12factor.net/config)
